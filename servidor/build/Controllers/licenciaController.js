...
class LicenciaController {
  listarLicencia(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      const licenciaLista = yield database_1.default.query(
  ...
  getOneLicencia(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      const { id } = req.params;
      const unaLicencia = yield database_1.default.query(
  ...
  modificarLicencia(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      const { id } = req.params;
      yield database_1.default.query('UPDATE licencia set ? WHERE idLice = ?', [
        req.body,
        id,
      ]);
  ...
  borrarLicencia(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      const { id } = req.params;
      yield database_1.default.query('DELETE FROM licencia WHERE idLice = ?', [
        id,
      ]);
