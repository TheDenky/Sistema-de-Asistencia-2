...
class PermisoController {
  listarPermiso(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      const permisoLista = yield database_1.default.query(
        'SELECT * FROM permiso'
      );
  ...
  getOnePermiso(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      const { id } = req.params;
      const unPermiso = yield database_1.default.query(
  ...
  modificarPermiso(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      const { id } = req.params;
      yield database_1.default.query('UPDATE permiso set ? WHERE idPerm = ?', [
        req.body,
        id,
      ]);
  ...
  borrarPermiso(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      const { id } = req.params;
      yield database_1.default.query('DELETE FROM permiso WHERE idPerm = ?', [
        id,
      ]);
