...
class PersonalController {
  list(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const personalLista = yield database_1.default.query(
  ...
  getOnePersonal(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const { id } = req.params;
      const unaPersona = yield database_1.default.query(
  ...
  update(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const { id } = req.params;
      yield database_1.default.query('UPDATE personal set ? WHERE idPers = ?', [
        req.body,
        id,
      ]);
  ...
  delete(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const { id } = req.params;
      yield database_1.default.query('DELETE FROM personal WHERE idPers = ?', [
        id,
      ]);
