...
class UsuarioController {
  listarUsuario(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      const UsuarioLista = yield database_1.default.query(
        'SELECT * FROM usuario'
      );
  ...
  modificarUsuario(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      const { id } = req.params;
      yield database_1.default.query('UPDATE usuario set ? WHERE idPers = ?', [
        req.body,
        id,
      ]);
  ...
  borrarUsuario(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      const { id } = req.params;
      yield database_1.default.query('DELETE FROM usuario WHERE idPers = ?', [
        id,
      ]);
