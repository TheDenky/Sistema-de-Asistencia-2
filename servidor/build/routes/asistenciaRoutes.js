...
class AsistenciaRoutes {
  ...
  config() {
    this.router.get(
      '/',
      asistenciaController_1.asistenciaController.listarAsistencia
    );
    this.router.get(
      '/:id',
    ...
    this.router.put(
      '/:id',
      asistenciaController_1.asistenciaController.modificarAsistencia
    );
    this.router.delete(
      '/:id',
      asistenciaController_1.asistenciaController.borrarAsistencia
    );
  }
}
