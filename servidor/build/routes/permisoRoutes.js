...
class PermisoRoutes {
  ...
  config() {
    ...
    this.router.get(
      '/:id',
      permisoController_1.permisoController.getOnePermiso
    );
    this.router.post('/', permisoController_1.permisoController.crearPermiso);
    this.router.put(
      '/:id',
      permisoController_1.permisoController.modificarPermiso
    );
    this.router.delete(
      '/:id',
      permisoController_1.permisoController.borrarPermiso
    );
  }
}
